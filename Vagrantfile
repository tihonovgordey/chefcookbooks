...
Vagrant.configure(2) do |config|
 config.vm.define "chef" do |chef|
  ...
  chef.vm.hostname = "chef.server.local"
 ...
 config.vm.define "node" do |node|
  ...
  node.vm.hostname = "chef.node.local"
  config.vm.provision :hosts do |provisioner|  
    provisioner.add_host '192.168.10.10', ['chef.server.local' , 'chef'] 
    provisioner.add_host '192.168.10.2', ['chef.node.local' , 'node']    
    provisioner.add_host '192.168.10.3', ['chef.workstation.local' , 'workstation'] 
   end 
 end
