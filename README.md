...
### Operation
There are three roles executed on node VM: PREPARE, MYSQL and JBOSS. After adding all three roles in nodes run list and changing nodes environment to `devops` all operations for preparation and setup of all needed complonents are automatic.  
### Problems 
